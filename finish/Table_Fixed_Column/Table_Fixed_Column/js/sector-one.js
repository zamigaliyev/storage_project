...
$(document).on("click", '.btn-edit', function(e){
    e.preventDefault()
    var div = $('<div class="stock">').append('<input style="border: 1px solid black" class="say-1" type="text" placeholder="Edit...">').append('<button id="btn-ok" class="btn btn-success azalt">ok</button>')
...
$(document).on("click", '.btn-editi', function(e){
    e.preventDefault()
    var div = $('<div class="stock">').append('<input style="border: 1px solid black" class="say-1" type="text" placeholder=".....">').append('<button id="btn-ok" class="btn btn-success artir">ok</button>')
    $(".cell100.column4").html(div)
    bid = $(this).data('id')
...
$(document).on("click", '.azalt', function(e){
 ...
 database.ref("sector1/item/" + id).update({
    stock: number -parseInt($(".say-1").val())
...
$(document).on("click", '.artir', function(b){
 ...
 database.ref("sector1/item/" + bid).update({
    stock: bnumber + parseInt($(".say-1").val())
